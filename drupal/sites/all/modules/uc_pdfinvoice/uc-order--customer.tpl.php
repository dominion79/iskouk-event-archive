 ...
 */
?>
<table width="95%" border="0" cellspacing="0" cellpadding="1" align="left" bgcolor="#006699" style="font-family: verdana, arial, helvetica; font-size: small;">
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="left" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: small;">
                    <tr>
                      <td valign="top" width="50%">
                        <b><?php print t('PkBilling Address:'); ?></b><br />
              ...
              <tr>
                <td colspan="1" bgcolor="#006699" style="color: white;">
...
<!--
              <tr>
                <td colspan="2">
                  ...
                  <table align="left" border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
-->
                    <tr>
                      <td nowrap="nowrap">
