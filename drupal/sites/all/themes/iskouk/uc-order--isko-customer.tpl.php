      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <p><b><?php print t('Thank you for registering for our event, !order_first_name, Details of your order are included in the attached document.', array('!order_first_name' => $order_first_name)); ?></b></p>
