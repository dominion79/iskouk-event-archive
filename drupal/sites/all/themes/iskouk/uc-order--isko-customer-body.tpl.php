    ...
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
		  ...
		  <td>
			<span style="font-size: xx-large;"><b><?php print t('INVOICE'); ?></b></span>
		  </td>
                <td nowrap="nowrap">
                  <?php print $store_address; ?><br /><br /><?php print t('Date: '); ?><?php print $site_current_date; ?>
                </td>
              </tr>
            </table>
          </td>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#006699" style="color: white;">
                  <b><?php print t('Registration Information:'); ?></b>
                </td>
              </tr>
              <tr>
                <td nowrap="nowrap">
                  <b><?php print t('Registrant:'); ?></b>
                </td>
                <td width="98%">
                  <?php print "$order_first_name $order_last_name"; ?>
                </td>
              </tr>
              <tr>
                <td nowrap="nowrap">
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: small;">
                    <tr>
                      <td valign="top" width="50%">
                        <b><?php print t('Billing Address:'); ?></b><br /><br />
              ...
              <tr>
                <td colspan="2" bgcolor="#006699" style="color: white;">
                  <b><?php print t('Registration Summary:'); ?></b>
                </td>
              </tr>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                    ...
                    <tr>
                      <td nowrap="nowrap">
                        <b><?php print t('Registration Date: '); ?></b>
                      </td>
                      <td width="98%">
                    ...
                    <tr>
                      <td nowrap="nowrap">
                        <b><?php print t('Total for this Item:'); ?>&nbsp;</b>
                      </td>
                      <td>
                        <b><?php print $order_total; ?></b>
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        <br /><br /><b><?php print t('Items on order:'); ?>&nbsp;</b>
                        ...
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                          ...
                          <tr>
                            ...
                            <td width="98%">
                              ...
                              <?php print t('Event Code'); ?>: <?php print $product->model; ?><br />
